...
pub enum Instr<'vm> {
    ...
    I64_S_SatAdd(Slot, Slot, Slot),
    I128_S_SatAdd(Slot, Slot, Slot),
    I8_U_SatAdd(Slot, Slot, Slot),
    I16_U_SatAdd(Slot, Slot, Slot),
    ...
    I64_S_SatSub(Slot, Slot, Slot),
    I128_S_SatSub(Slot, Slot, Slot),
    I8_U_SatSub(Slot, Slot, Slot),
    I16_U_SatSub(Slot, Slot, Slot),
